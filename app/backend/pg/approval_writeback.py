...
# ==========================================================================
def apply_outcome(session: Session, instance: Mapping[str, Any]) -> None:
    ...
    handler(session, instance, target)


# ==========================================================================
# Shared helpers
# ==========================================================================
def _closing_actor(session: Session, instance: Mapping[str, Any]) -> str:
...
def _apply_budget_revision(session: Session, instance: Mapping[str, Any],
    ...
    actor = _closing_actor(session, instance)
