...
## 2026-09-08 — migration 019: 014's replay fix reached rows that have no identity
...
**That fix is correct and 019 keeps every part of it.** What 014 did not
...
019 makes the index partial on `receive_external_id IS NOT NULL` and changes
...
correction**, not a decision: 019 restores an intent 013 stated in writing and
